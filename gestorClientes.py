...
def nuevo_cliente():
    ...
    bguardar = Button(top, text="Guardar", command=guardar)
    bguardar.grid(row=3, column=1)
...
def eliminar_cliente():
    ...
    rpta = messagebox.askokcancel("Seguro?", "Estás seguro de querer eliminar el cliente "+cliente[1]+"?")
    if rpta:
...
btn_delete = Button(root, text="Eliminar cliente", command=eliminar_cliente)
